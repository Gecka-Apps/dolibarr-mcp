...
@pytest.mark.asyncio
async def test_project_ref_defers_to_dolibarr_numbering(dolibarr_api_server):
    """Projects send ref='auto' so Dolibarr's numbering module assigns the ref."""
    base_url, created, statuses = dolibarr_api_server
    config = Config(
